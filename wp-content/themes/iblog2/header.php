...
<script>
  DD_belatedPNG.fix('.png_bg, img, #sidebar ul li, .plimage');
 </script>
<style>
...
<div id="page" class="fix">
	...
	<div id="nav" class="fix">
		<ul class="fix">
			<li class="page_item "><a class="home" href="<?php echo get_settings('home'); ?>/" title="Home"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/home-icon-trans.png"/></a></li>
			<?php 
